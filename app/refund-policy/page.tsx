...
export default function RefundPolicyPage() {
  ...
  return (
    <main className="bg-white">
      ...
      <Breadcrumb data={sectionData.LegalBreadcrumb?.variants?.VenueRefundBreadcrumb1} />
      
      <LegalPageContent data={sectionData.LegalPageContent?.variants?.VenueRefundPage} />
