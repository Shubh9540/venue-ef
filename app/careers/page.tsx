...
export default function CareersPage() {
  ...
  return (
    <main className="bg-white">
      ...
      <Breadcrumb data={sectionData.CareersBreadcrumb?.variants?.VenueCareersBreadcrumb1} />
      
      <CareersPageContent data={sectionData.CareersPageContent?.variants?.VenueCareersPage1} />
