...
export default function CookiesPolicyPage() {
  ...
  return (
    <main className="bg-white">
      ...
      <Breadcrumb data={sectionData.LegalBreadcrumb?.variants?.VenueCookiesBreadcrumb1} />
      
      <LegalPageContent data={sectionData.LegalPageContent?.variants?.VenueCookiesPage} />
