...
export default function DisclaimerPage() {
  ...
  return (
    <main className="bg-white">
      ...
      <Breadcrumb data={sectionData.LegalBreadcrumb?.variants?.VenueDisclaimerBreadcrumb1} />
      
      <LegalPageContent data={sectionData.LegalPageContent?.variants?.VenueDisclaimerPage} />
